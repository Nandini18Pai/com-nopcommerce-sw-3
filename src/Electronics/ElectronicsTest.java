...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@name= 'Password']"), "Monday@123");
        sendTextToElement(By.xpath("//input[@id='ConfirmPassword']"), "Monday@123");
        ...
        // Expire date
        selectByValue(By.xpath("//select[@id='ExpireMonth']"), "3");
        // Expire Year
        selectByValue(By.xpath("//select[@id='ExpireYear']"), "2025");
        // Card code
